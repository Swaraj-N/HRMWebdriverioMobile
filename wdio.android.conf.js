...
exports.config = {
    ...
    suites: {
        ...
        paymentScenario:["./test/specs/paymentScenario.spec.js"]
    },
    exclude: [
  ...
  Pixel_2_V8 */
    ...
    capabilities: [
        ...
        // {
        //     "appium:platformName": "Android",
        //     "appium:deviceName": "Pixel_2_V12",
        //     "appium:automationName": "UIAutomator2",
        //     "appium:platformVersion": "12.0",
        //     "appium:app": path.join(process.cwd(), "./app/android/PaymentGateway.apk"),
        //     "appium:autoGrantPermissions": true,
        //     "appium:unicodeKeyboard ": true,
        //     "appium:resetKeyboard": true,
        // },
     ...
     */
    before: function () {
        require('../HRMWebdriverioMobile/utils/customCommand')
      },
    /**
